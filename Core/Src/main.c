...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, LED_ALARM_Pin|LED_SET_Pin|LED_COMM_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SEG_TR_3_Pin SEG_TR_2_Pin SEG_TR_1_Pin */
  GPIO_InitStruct.Pin = SEG_TR_3_Pin|SEG_TR_2_Pin|SEG_TR_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : SW_MODE_Pin SW_UP_Pin SW_DOWN_Pin SW_SET_Pin */
  GPIO_InitStruct.Pin = SW_MODE_Pin|SW_UP_Pin|SW_DOWN_Pin|SW_SET_Pin;
  ...
  /*Configure GPIO pins : LINE_ALARM_Pin LINE_OPEN_Pin */
  GPIO_InitStruct.Pin = LINE_ALARM_Pin|LINE_OPEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : LED_PW_Pin LED_ERROR_Pin */
  GPIO_InitStruct.Pin = LED_PW_Pin|LED_ERROR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
